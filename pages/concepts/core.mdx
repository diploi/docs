...
the Core should run 1h, 8h and Forever. Time based Cores are a terrific way of saving on costs for projects
...
<Callout type="default" emoji="💡">
  Please note: Diploi is currently under development. Please contact us if you
  want to use the paid plan. Remember to mention your account name at
...
When you no longer need a Core it can be deleted. However you need to delete all projects and deployments 
running on the Core first.

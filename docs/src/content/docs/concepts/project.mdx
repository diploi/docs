...
:::note
**Using an existing repository and importing an application to Diploi** is not yet an automagically process, but it is possible. If you would like to bring your existing application to Diploi, contact us on [Discord](https://discord.gg/YV6GYpbQRG) or [via email](mailto:hello@diploi.com).
:::

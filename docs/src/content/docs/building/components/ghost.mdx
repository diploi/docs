...
export const ghostDetails = extractElement(AllElements,'ghost')
export const ghostPackage = repoURLPackageBuilder(ghostDetails.url,ghostDetails.versions.pop())

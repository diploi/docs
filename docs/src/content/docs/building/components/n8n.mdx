...
export const n8nPackage = repoURLPackageBuilder(n8nDetails.url,n8nDetails.versions.pop())
export const postgresPackage = repoURLPackageBuilder(postgresDetails.url,postgresDetails.versions.pop())

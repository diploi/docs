...
- `DIPLOI_AI_GATEWAY_URL` / `DIPLOI_AI_GATEWAY_TOKEN` - Diploi AI Gateway credentials (injected automatically). See [AI Gateway](/reference/ai-gateway).
...
- [AI Gateway](/reference/ai-gateway)

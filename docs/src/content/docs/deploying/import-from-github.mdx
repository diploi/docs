...
If you already have an application that you would like to bring into Diploi, you can import them using **GitHub**. Although it is technically possible to import any application, not every kind of app will work right away, and it might require adjustments in order to work properly after import.

***

## Supported Applications

We currently offer complete support for applications built with:

<ElementList type={'component'} elementsToShow={['Lovable','Node.js','React + Vite']}/>

Currently you can import to Diploi any application built using **Lovable** or with **Diploi**.

### How to import an app built with Lovable

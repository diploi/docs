...
- **Development** which allows you to start a server on which you can start a remote development environment using VSCode or our cloud IDE, or connect directly to the server via SSH. For more about remote development, check out our [Remote Development guide](/building/remote-development/).
...
:::note
Your development environment and, each component and add-on of your app's stack are running on independent containers.
:::

...
- **Development** which allows you to start a server on which you can start a remote development environment using VSCode or our browser IDE, or connect directly to the server via SSH. For more about remote development, check out our [Remote Development guide](/guides/remote-development/)
...
For more information on how to connect to your deployment via SSH, check out our [SSH guide](/guides/ssh/).

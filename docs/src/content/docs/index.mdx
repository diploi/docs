...
We currently do not offer out-of-the-box support for launching an existing applications, but it is already possible, if you want to host an existing project with Diploi, contact us on [Discord](https://discord.gg/vvgQxVjC8G) or [via email](mailto:hello@diploi.com).
:::

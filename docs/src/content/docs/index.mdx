...
Diploi uses a component-driven architecture to build your application. You can pick and choose your stack from a constantly growing list of components and add-ons.

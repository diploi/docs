...
Diploi is a platform and workflow for managing and hosting your full application from zero using some of the most popular frameworks and databases, without having to set up virtual machines, struggle setting up deployment pipelines, SSL certificates, load balancers or other DevOps pains. No more context switching, local dependencies or configuration hell.
...
:::note
Diploi is designed to be the starting point for your new applications,

We currently do not offer out-of-the-box support for launching an existing applications, but it is already possible, if you want to host an existing project with Diploi, contact us on [Discord](https://discord.gg/YV6GYpbQRG) or [via email](mailto:hello@diploi.com).
:::
...
Diploi uses a component-driven architecture to build your application. You choose your stack from a constantly growing list of components and add-ons.

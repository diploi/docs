...
:::note
Depending on the deployment stage of your deployment, the overview page will show different information. **For Development deployments**, the overview will show an additional entry **Development**, which allows you to access the remote development environment using our browser IDE or VS code.
:::

...
:::note
Not all components support the `hosts` directive yet. Check the component's repository for details.
:::
...
A unique slug for this host entry within the component. The identifier becomes part of the internal hostname that other components use to reach this service. You can view the full internal hostname in the Diploi Console.

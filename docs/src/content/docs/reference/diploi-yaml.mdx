...
reach the service, and of the `<IDENTIFIER>_ENDPOINT` environment variable the component gets for it. The full
hostname is in the Diploi Console and in [`diploi describe <component>`](/reference/diploi-cli#diploi-describe).

...
You will be able to create deployments. Each deployment represents a virtual machine that serves your application online. For a deeper dive on deployments, check the article about [Deployments](/reference/deployments/deployment).

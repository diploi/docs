...
### Choosing Between Creating a Project with Repository or a Quick Launch

A **Repository Launch** is the easiest way to set up a project is to let Diploi bootstrap a new GitHub repository for you. This will ensure that the repository contains the right files to make the project run.

A **Quick launck** is the fatest way to launch a VM in seconds and it can be used when you need to run a simple script online or just want to test drive Diploi. With a Quick Launch, you create an project without a repository attached to it.

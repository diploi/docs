...
### AI Gateway
An OpenAI- and Anthropic-compatible proxy available inside every Diploi deployment at `core.diploi`. Apps and coding tools use it to call supported models without storing provider API keys. Usage is billed from the account balance.

_See also:_ [AI Gateway](/reference/ai-gateway)
...
### CLI
CLI is an acronym that stands for **Command Line Interface**, and it is a text-based interface used to interact with a computer system or a specific program by typing commands.
...
_See also:_ [CI/CD](#ci-cd), [Repository Launch](#repository-launch), [How Diploi uses GitHub Actions](/reference/github-action/), [More about GitHub Actions](https://docs.github.com/en/actions)

...
1. [**Quick launch**](#quick-launch), recommended to launch simple APIs, code snippets, and simple applications in seconds. You can think of it as an alternative to cloud functions where you have control over the virtual machine running your functions, without the need for version control and want to focus mainly on the code.

2. [**Repository launch**](#repository-launch), allows you to deploy new applications with a repository bootstrap for you application. All you need is to sign up using a Github account. We recommend you use this method if you plan to deploy production-ready applications.
...
<Image src={QuickStartBuilder} alt="Quick launch builder"/>
...
<Image src={QuickLaunchLoading} alt="Quick launch loading"/>
...
<Image src={QuickLaunchHome} alt="Quick launch home"/>


:::tip
Quick launch is an alternative for launching small applications and simple APIs.
:::
...
##### Components
<Image src={CreateProjectComponents} alt="Project components"/>

##### Add-ons
<Image src={CreateProjectAddons} alt="Project add-ons"/>

Once you have chosen the stack for your project, you will be able to see a preview of your selected stack.

##### Stack preview
<Image src={CreateProjectPreview} alt="Create a project example"/>
...
<Image src={CreateProjectEditNames} alt="Create a project example"/>
...
<Image src={CreateProjectRepo} alt="Create a project repo"/>
...
<Image src={CreateDeploymentSize} alt="Deployment size"/>
...
<Image src={CreateDeploymentConnect} alt="Connect to deployment with SSH"/>
:::
...
<Image src={DisableDeploymentCard} alt="Shutdown deployment"/>
...
<Image src={DisableDeploymentSwitch} alt="Shutdown switch"/>

You can restart your Deployment at any time by clicking on the same switch you used for shutdown

<Image src={EnableDeployment} alt="Restart deployment"/>

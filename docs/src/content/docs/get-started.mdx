...
* [**Instant launch**](#instant-launch) if you want to try Diploi and don't want to create an account or
...
If you don't have an account Diploi, you can get started with an **instant launch**, this will create a deployment in which you can access directly using our browser IDE, connect remotely using VS code or connect directly to the remote server using SSH.
...
![Instant launch builder](../../assets/QuickStartBuilder.png)
...
![Instant launch builder](../../assets/InstantLaunchLoading.png)
...
![Instant launch builder](../../assets/QuickLaunchHome.png)
...
![Instant launch builder](../../assets/ClaimAccount.png)
:::
...
##### Components
![Create a project example](../../assets/CreateProjectComponents.png)

##### Add-ons
![Create a project example](../../assets/CreateProjectAddons.png)

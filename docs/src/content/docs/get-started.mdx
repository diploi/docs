...
You have two options on how to get started

1. [**Quick Launch**](#quick-launch), recommended to launch simple APIs, code snippets, and simple applications in seconds. You can play around with different tech stacks and technologies without registering or even using a code repository, just focus on your code.


2. [**Repository Launch**](#repository-launch), the normal way to deploy new applications connected to a repository in your GitHub account. All you need is to sign up using a Github account. We recommend you use this method for all your normal long-lived projects.

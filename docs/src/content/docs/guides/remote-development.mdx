---
title: Usign Remote Development
...
To connect to your remote development environment using your own IDE, you need to add your public SSH key, which you can do by following the instructions in our [SSH guide](/guides/ssh/).

Diploi officially supports:
- [VS Code](https://code.visualstudio.com/) with the Remote Development extension

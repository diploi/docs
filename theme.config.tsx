...
const config: DocsThemeConfig = {
  logo: (
    <svg xmlns="http://www.w3.org/2000/svg" /*width="445" height="132"*/ fill="none" viewBox="0 0 445 132" width={108} height={32}>
      <g clipPath="url(#a)">
        <path
          fill="white" /* THIS SHOULD REACT TO THEME */
        ...
        />
        <path fill="url(#b)" fillRule="evenodd" d="M12.596 0h77.949l37.788 66h-27.565L75.576 22.061H25.192L12.596 0Z" clipRule="evenodd" />
        <path
          fill="url(#c)"
          fillRule="evenodd"
          ...
          clipRule="evenodd"
        />
        <path fill="url(#d)" fillRule="evenodd" d="M25.192 22.06 0 66h50.384l25.192-43.94H25.192Z" clipRule="evenodd" />
        <path fill="url(#e)" fillRule="evenodd" d="M25.192 109.939 0 66h50.384l25.192 43.939H25.192Z" clipRule="evenodd" />
      </g>
      <defs>
        <linearGradient id="b" x1="70.465" x2="70.465" y1="0" y2="66" gradientUnits="userSpaceOnUse">
          <stop stopColor="#842EFF" />
          <stop offset=".995" stopColor="#3D04BD" />
        </linearGradient>
        <linearGradient id="c" x1="70.465" x2="70.465" y1="66" y2="132" gradientUnits="userSpaceOnUse">
          <stop stopColor="#BA89FF" />
          <stop offset="1" stopColor="#EBDCFF" />
        </linearGradient>
        <linearGradient id="d" x1="37.788" x2="37.788" y1="22.06" y2="65.999" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FFACCF" />
          <stop offset="1" stopColor="#FFCEE3" />
        </linearGradient>
        <linearGradient id="e" x1="37.788" x2="37.788" y1="66" y2="109.939" gradientUnits="userSpaceOnUse">
          <stop stopColor="#F685B6" />
          <stop offset="1" stopColor="#CA4A87" />
        </linearGradient>
        <clipPath id="a">
  ...
  project: {
    link: 'https://github.com/diploi',
  },
  /*chat: {
    link: 'https://discord.com',
  },*/
  docsRepositoryBase: 'https://github.com/diploi/docs',
  footer: {
    text: 'Diploi Documentation',
  },
  //pprimaryHue: { dark: 248, light: 248 }, // 248 for real?
  primaryHue: { dark: 217, light: 217 }, // 248 for real?
  darkMode: false, // Hide toggle
  useNextSeoProps: () => {
    return {
      titleTemplate: '%s – Diploi',
    };
  },
};
